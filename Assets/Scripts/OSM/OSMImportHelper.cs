...
namespace Transidious
{
    ...
    public class OSMImportHelper
    {
        ...
        void ImportArea(PBFOsmStreamSource allNodes)
        {
            ...
            case Area.Karlsruhe:
                {
                    ...
                    foreach (var geo in sourceStream)
                    {
                        ...
                        case OsmGeoType.Relation:
                            ...
                            while (true)
                            {
                                if (tags.Contains("name", "Karlsruhe"))
                                {
                                    if (tags.Contains("type", "boundary") && tags.Contains("admin_level", "6"))
                                    {
                                        importer.boundary = geo as Relation; AddGeoReference(geo); break;
            ...
            case Area.Freiburg:
                {
                    ...
                    foreach (var geo in sourceStream)
                    {
                        ...
                        case OsmGeoType.Relation:
                            ...
                            while (true)
                            {
                                if (tags.Contains("name", "Freiburg im Breisgau"))
                                {
                                    if (tags.Contains("type", "boundary") && tags.Contains("admin_level", "6"))
                                    {
                                        importer.boundary = geo as Relation; AddGeoReference(geo); break;
            ...
            case Area.Frankfurt:
                {
                    ...
                    foreach (var geo in sourceStream)
                    {
                        ...
                        case OsmGeoType.Relation:
                            ...
                            while (true)
                            {
                                if (tags.Contains("name", "Frankfurt am Main"))
                                {
                                    if (tags.Contains("type", "boundary") && tags.Contains("admin_level", "6"))
                                    {
                                        importer.boundary = geo as Relation; AddGeoReference(geo); break;
            ...
            case Area.NewYorkCity:
                {
                    ...
                    foreach (var geo in sourceStream)
                    {
                        ...
                        case OsmGeoType.Relation:
                            ...
                            while (true)
                            {
                                if (tags.Contains("name", "NewYorkCity"))
                                {
                                    if (tags.Contains("type", "boundary") && tags.Contains("admin_level", "5"))
                                    {
                                        importer.boundary = geo as Relation; AddGeoReference(geo); break;
            ...
            var allNodesList = allNodes.ToArray();

            foreach (var way in allNodesList.OfType<Way>())
            {
            ...
            foreach (var geo in allNodesList)
            {
